<template>
  <div>
    <div v-if="!showEdit" class="container">
      ...
      <el-table stripe v-loading="couponLoading" :data="tableData">
        ...
        <el-table-column fixed="right" width="150" label="操作">
          <template slot-scope="scope">
            ...
            <el-button
              v-permission="{ auth: ['删除Coupon'], type: 'disabled' }"
      ...
      <el-table stripe v-loading="couponTemplateLoading" :data="templates">
        <el-table-column prop="id" label="id" width="100"></el-table-column>
        ...
        <el-table-column fixed="right" width="300" label="操作">
          <template slot-scope="scope">
            <el-button
              v-permission="{ permission: ['创建Coupon'], type: 'disabled' }"
...
export default {
  ...
  async created() {
    ...
    this.couponTemplateLoading = true
    this.$nextTick(() => {
      this.getCoupons()
      this.getTemplates()
    })
  ...
  methods: {
    ...
    async getTemplates() {
      ...
      this.couponTemplateLoading = false
    },
