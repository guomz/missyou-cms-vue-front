            ...
            <el-form :model="form" status-icon ref="form" label-width="100px" @submit.native.prevent>
              ...
              <el-form-item label="是否上架">
                <el-switch
                  ...
                  :disabled = "isCreate"
                ></el-switch>
                <div v-if="isCreate">默认spu创建后状态为下架，添加sku后方可上架。</div>
              </el-form-item>
...
export default {
  ...
  methods: {
    ...
    async getValue() {
      ...
      }else if(!val2 || val2.length == 0){
        this.form.spu_detail_img_list = null
      }
    },
    back() {
      this.$emit('editClose')
