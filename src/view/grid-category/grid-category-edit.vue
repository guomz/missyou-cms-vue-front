  ...
  <el-dialog :append-to-body="true" :before-close="handleClose" :visible.sync="visible">
    <div style="margin-top:-25px;">
      ...
      <el-form :model="form" status-icon ref="form" label-width="100px" @submit.native.prevent>
        ...
        <el-form-item label="分类" prop="root_category_id">
          <el-autocomplete
    ...
    <div slot="footer" class="dialog-footer" style="padding-left:5px;">
      <el-button type="primary" @click="submitForm" v-permission="{ permission: '更新GridCategory', type: 'disabled' }"
        >确 定</el-button
      >
...
export default {
  ...
  methods: {
    ...
    handleSelect(item) {
      ...
      this.form.root_category_id = item.id
    },
    async getValue() {
    ...
    async loadSuggestions() {
      try {
        this.suggestions = await Category.getAllMainCategories()
