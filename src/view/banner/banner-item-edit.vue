          ...
          <el-col :lg="16" :md="20" :sm="24" :xs="24">
            <el-form :model="form" status-icon ref="form" label-width="100px" @submit.native.prevent>
              ...
              <el-form-item label="关键字" prop="keyword">
                <el-input size="medium" v-model="form.keyword" placeholder="请填写关键字(类型为1时填写spu的id，其余情况填写主题theme的name)"></el-input>
              </el-form-item>
              <el-form-item label="类型" prop="type">
                <el-input size="medium" v-model="form.type" placeholder="请填写类型(1:spu，2:主题，3:主题的spu列表)"></el-input>
              </el-form-item>
              ...
              <el-form-item class="submit">
                <el-button
                  v-permission="{ permission: ['创建BannerItem', '更新BannerItem'], type: 'disabled' }"
                  type="primary"
