  ...
  <div>
    <div v-if="!showEdit" class="container">
      <div class="header">
        ...
        <el-button v-permission="{ auth: ['创建CouponTemplate'], type: 'disabled' }" style="margin-left:30px;" @click.prevent="addCouponTemplate" type="primary" plain size="medium"
          >新增优惠券模板</el-button
        >
      </div>
      ...
      <el-table stripe v-loading="loading" :data="templates">
        ...
        <el-table-column fixed="right" width="150" label="操作">
          <template slot-scope="scope">
            <el-button v-permission="{ auth: ['更新CouponTemplate'], type: 'disabled' }" @click.prevent="handleEdit(scope.row)" type="primary" plain size="mini">编辑</el-button>
            <el-button
              v-permission="{ auth: ['删除CouponTemplate'], type: 'disabled' }"
